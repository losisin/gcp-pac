...
export const disallowAdminPrivileges = {
	name: 'projects-disallow-admin-privileges',
	description: `Check that Projects Service Account has no admin privileges.`,
	enforcementLevel: 'advisory' as EnforcementLevel,
	validateResource: (args: ResourceValidationArgs, reportViolation: ReportViolation) => {
		const message = `Service Account shouldn't have admin privileges on project level.`
