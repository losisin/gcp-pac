...
export const disallowEndOfLifeRuntime = {
	name: 'cloudrunfunctionsv2-function-disallow-end-of-life-runtime',
	...
	validateResource: (args: ResourceValidationArgs, reportViolation: ReportViolation) => {
		if (args.type === 'gcp:cloudfunctionsv2/function:Function') {
			const message =
				'CloudFunctions function should use runtime with active or security support.'
			const runtime = args.props.buildConfig?.runtime
